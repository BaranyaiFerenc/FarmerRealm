...
int main(int argc, char *argv[])
{
    ...
    //A betûkészlet Microsoft Corporation által 8514syse.fon Windows 10-ben megtalálható elõre telepített
    TTF_Init();
    ...
    //Az építhetõ épületek deklarálása (név, ár, szint, idõ, azonosító)
    ...
    //Ültethetõ növények deklarálása (név, ár, szint, idõ, azonosító)
    ...
    Recipes[4] = (Recipe){.itemIds = {7, NULL}, .itemAmounts = {10,NULL}, .resultId = 8, .resultAmount = 6, .type = Bakery, .t = 300, .id = 4}; //Kenyér
    ...
    //Ha már van elmentett idõ akkor ez hozzáadja a mostanihoz
    ...
    while (event.type != SDL_QUIT)
    {
        ...
        //Mód jelzõ feliratok létrehozása
        ...
        //Az építõ-és ültetõ menü animált megjelenítése
        ...
        //Romboló gomb külön kerül megjelenítésre mivel ez nem hasonlít az ültetõ panel elemeihez így nem szabványos
...
//Az aktuális növény képének kiszámolása a hátralévõ idõbõl
int GetPlantImageId(ShopItem *plant, unsigned long long int TimeWhenDone)
{
